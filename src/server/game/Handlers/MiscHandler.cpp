...
void WorldSession::HandleGossipSelectOptionOpcode(WorldPacket& recvData)
{
    ...
    else if (guid.IsItem())
    {
        ...
        {
			TC_LOG_DEBUG("network", "WORLD: HandleGossipSelectOptionOpcode - Item %s not found.", guid.ToString().c_str());
            return;
        }
    }
    else if (guid.IsPlayer())
    {
        ...
        {
			TC_LOG_DEBUG("network", "WORLD: HandleGossipSelectOptionOpcode - Player %s invalid.", guid.ToString().c_str());
            return;
        }
    }
    else
